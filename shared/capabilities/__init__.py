...
registry.register(Capability(
    ...
    used_by=frozenset({"workout-program"}),
...
registry.register(Capability(
    ...
    dependencies=frozenset({"training-intelligence"}),
    blocked_by=frozenset(),
    used_by=frozenset({"ai-coach", "prediction-engine"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    dependencies=frozenset({"training-intelligence"}),
    blocked_by=frozenset({"recovery-settings"}),
    used_by=frozenset({"ai-coach", "decision-intelligence"}),
...
registry.register(Capability(
    ...
    dependencies=frozenset({"training-intelligence", "nutrition-intelligence", "recovery-intelligence"}),
    blocked_by=frozenset({"recovery-intelligence"}),
    used_by=frozenset({"ai-coach", "workout-program"}),
...
registry.register(Capability(
    ...
    dependencies=frozenset(),
    blocked_by=frozenset(),
    used_by=frozenset({"decision-intelligence", "ai-coach", "prediction-engine"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    dependencies=frozenset(),
    blocked_by=frozenset(),
    used_by=frozenset({"knowledge-platform", "training-intelligence", "nutrition-intelligence"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"training-intelligence", "nutrition-intelligence", "recovery-intelligence", "decision-intelligence"}),
    blocked_by=frozenset({"recovery-intelligence"}),
    used_by=frozenset(),
    risk_level=RiskLevel.MEDIUM,
    priority=CapabilityPriority.MEDIUM,
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"decision-intelligence", "knowledge-platform", "training-intelligence", "nutrition-intelligence", "recovery-intelligence"}),
    blocked_by=frozenset({"decision-intelligence", "recovery-intelligence"}),
    used_by=frozenset({"prediction-engine", "digital-twin"}),
    risk_level=RiskLevel.HIGH,
...
registry.register(Capability(
    ...
    dependencies=frozenset({"training-intelligence", "nutrition-intelligence", "recovery-intelligence", "knowledge-platform"}),
    blocked_by=frozenset(),
    used_by=frozenset({"digital-twin", "decision-intelligence", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"prediction-engine", "ai-coach", "knowledge-platform", "training-intelligence", "nutrition-intelligence", "recovery-intelligence"}),
    blocked_by=frozenset({"prediction-engine", "ai-coach"}),
    used_by=frozenset(),
    risk_level=RiskLevel.HIGH,
    priority=CapabilityPriority.LOW,
    documentation_links=(),
...
registry.register(Capability(
    ...
    dependencies=frozenset(),
    blocked_by=frozenset(),
    used_by=frozenset({"product-intelligence"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=2, critical=0, high=0, medium=1, low=1),
    dependencies=frozenset({"capability-platform"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach", "planning-engine"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=2, critical=0, high=0, medium=1, low=1),
    dependencies=frozenset({"capability-platform", "intent-platform"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach", "workout-program"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
...
registry.register(Capability(
    ...
    completion=CompletionMetrics(current_percent=100, target_percent=100, remaining_tasks=0, total_tasks=24),
    technical_debt=TechnicalDebtSummary(total_items=1, critical=0, high=0, medium=1, low=0),
    dependencies=frozenset({"capability-platform", "planning-engine", "intent-platform"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"capability-platform", "knowledge-evolution", "optimization-knowledge", "planning-optimizer", "planning-engine", "intent-platform"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"capability-platform", "optimization-knowledge", "planning-optimizer", "planning-engine"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    completion=CompletionMetrics(current_percent=100, target_percent=100, remaining_tasks=0, total_tasks=24),
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"capability-platform", "planning-optimizer", "planning-engine"}),
    blocked_by=frozenset(),
    used_by=frozenset({"prediction-engine", "decision-intelligence", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
...
registry.register(Capability(
    ...
    completion=CompletionMetrics(current_percent=100, target_percent=100, remaining_tasks=0, total_tasks=28),
    technical_debt=TechnicalDebtSummary(total_items=0, critical=0, high=0, medium=0, low=0),
    dependencies=frozenset({"product-intelligence", "capability-platform", "experience-platform", "prediction-engine", "recovery-intelligence", "planning-engine"}),
    blocked_by=frozenset(),
    used_by=frozenset({"experience-platform", "ai-coach"}),
    risk_level=RiskLevel.LOW,
    priority=CapabilityPriority.HIGH,
    documentation_links=(
