...
class DarkColorTokens:
    primary: str = "#818CF8"
    primary_hover: str = "#6B7AF5"
    primary_variant: str = "#141336"

    secondary: str = "#38BDF8"
    secondary_hover: str = "#2BA0E8"
    secondary_variant: str = "#0C2236"

    accent: str = "#F9A03F"
    accent_hover: str = "#E88D2A"
    accent_variant: str = "#2D1508"
    ...
    background_alt: str = "#080D18"
    surface: str = "#0F172A"
    surface_hover: str = "#1A2235"
    surface_active: str = "#243045"
    surface_raised: str = "#1A2235"
    surface_elevated: str = "#1E293B"
    border: str = "rgba(255, 255, 255, 0.06)"
    border_light: str = "rgba(255, 255, 255, 0.03)"
    border_hover: str = "rgba(255, 255, 255, 0.12)"

    text_primary: str = "#F1F5F9"
    text_secondary: str = "#8899AA"
    text_disabled: str = "#556677"
    text_inverse: str = "#0B1120"
