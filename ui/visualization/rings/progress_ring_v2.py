...
class ProgressRingV2(BaseVisualization):
    """Circular progress ring with token-driven color and animated transitions."""
    ...
    def paintEvent(self, event) -> None:
        ...
        painter.drawText(QRectF(0, cy - 24, self._ring_size + 20, 30), Qt.AlignCenter, f"{pct}")

        painter.setFont(self._make_font(10))
        painter.setPen(QColor(colors.text_disabled))
        painter.drawText(QRectF(0, cy + 6, self._ring_size + 20, 16), Qt.AlignCenter, "%")
